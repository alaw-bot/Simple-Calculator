...
BEGIN_MESSAGE_MAP(CMFCApplication2App, CWinApp)
	...
	ON_COMMAND(ID_MENU_ABOUT, &CMFCApplication2App::OnMenuAbout)
END_MESSAGE_MAP()
...
void CMFCApplication2App::OnMenuAbout()
{
	AfxMessageBox(L"Group Members\n20/ENG/043-Fernando W.N.R.\n20/ENG/202-Thushithan S.\n20/ENG/144-Tharsan I.\n20/ENG/177-Bharkkavasharma K.");
}
